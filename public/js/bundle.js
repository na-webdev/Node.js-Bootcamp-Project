    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alert.showAlert)('success', "".concat(type[0].toUpperCase() + type.slice(1), " successfully updated!"));
            _context.next = 11;
            break;
...
var stripe = Stripe('pk_test_51LUtV0ICry0AjEOSkXUNMQ1gI9PzMCdRBWNcMUtfy7A9JnpuXoxZ2fdBRbqEHABIX7gU0fS37WVsRplRzUZE97HP00si1gXi9Y');
...
var signInForm = document.querySelector('.form--login');
var signOutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour');
console.log('🚀 ~ file: index.js ~ line 15 ~ bookBtn', bookBtn); // delegation
...
if (signOutBtn) signOutBtn.addEventListener('click', _login.logout);
